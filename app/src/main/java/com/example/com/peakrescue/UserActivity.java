        ...
        if (locationManager != null){
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                ...
                if (lastKnownLocation != null){
                    ...
                    sp_altitude = Double.toString(altitude);
...
//      Set the respiration rate on text view on the screen
        sp_respiratoryrate = String.valueOf(resp_rate);
...
//      Return the respiratory rate
    ...
    private void setSharedPrefData() {
        ...
        try {
            ...
            allData.put("heartrate", sp_heartrate);
            allData.put("respiratoryrate", sp_respiratoryrate);
            allData.put("altitude", sp_altitude);
